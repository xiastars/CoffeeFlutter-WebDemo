define(['dart_sdk', 'packages/source_span/source_span'], function(dart_sdk, source_span) {
  ...
  const _scanner = dart.privateName(src__line_scanner, "_scanner");
  ...
  const _scanner$ = dart.privateName(src__relative_span_scanner, "_scanner");
  ...
  const _scanner$0 = dart.privateName(src__span_scanner, "_scanner");
  ...
  const _line$ = dart.privateName(src__eager_span_scanner, "_line");
  const _column$ = dart.privateName(src__eager_span_scanner, "_column");
  const _betweenCRLF$ = dart.privateName(src__eager_span_scanner, "_betweenCRLF");
  const _scanner$1 = dart.privateName(src__eager_span_scanner, "_scanner");
  const _newlinesIn$ = dart.privateName(src__eager_span_scanner, "_newlinesIn");
  const _adjustLineAndColumn$ = dart.privateName(src__eager_span_scanner, "_adjustLineAndColumn");
