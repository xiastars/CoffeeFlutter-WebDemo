define(['dart_sdk'], function(dart_sdk) {
  ...
  src__path_set.PathSet = class PathSet extends collection.IterableBase$(core.String) {
    ...
    cast(T) {
      return core.Set$(T)._check(this[_inner].cast(T));
    }
    clear() {
  ...
  (src__path_set.PathSet.of = function(other, opts) {
    let context = opts && 'context' in opts ? opts.context : null;
    let _ = src__path_set.PathSet._create(context);
    _.addAll(other);
    this[_inner] = _;
    src__path_set.PathSet.__proto__.new.call(this);
  }).prototype = src__path_set.PathSet.prototype;
  dart.addTypeTests(src__path_set.PathSet);
  src__path_set.PathSet[dart.implements] = () => [SetOfString()];
  ...
  dart.setFieldSignature(src__path_set.PathSet, () => ({
    ...
    [_inner]: dart.finalFieldType(SetOfString())
  }));
  ...
  src__path_map.PathMap$ = dart.generic(V => {
    ...
    (PathMap.of = function(other, opts) {
      let context = opts && 'context' in opts ? opts.context : null;
      PathMap.__proto__.new.call(this, (() => {
        let _ = src__path_map.PathMap._create(V, context);
        _[$addAll](other);
        return _;
      })());
    }).prototype = PathMap.prototype;
  ...
  const name$ = Symbol("UrlStyle.name");
  const separator$ = Symbol("UrlStyle.separator");
  const separators$ = Symbol("UrlStyle.separators");
  const separatorPattern$ = Symbol("UrlStyle.separatorPattern");
  const needsSeparatorPattern$ = Symbol("UrlStyle.needsSeparatorPattern");
  const rootPattern$ = Symbol("UrlStyle.rootPattern");
  const relativeRootPattern$ = Symbol("UrlStyle.relativeRootPattern");
  ...
  const name$0 = Symbol("PosixStyle.name");
  const separator$0 = Symbol("PosixStyle.separator");
  const separators$1 = Symbol("PosixStyle.separators");
  const separatorPattern$0 = Symbol("PosixStyle.separatorPattern");
  const needsSeparatorPattern$0 = Symbol("PosixStyle.needsSeparatorPattern");
  const rootPattern$0 = Symbol("PosixStyle.rootPattern");
  const relativeRootPattern$0 = Symbol("PosixStyle.relativeRootPattern");
  ...
  src__context._validateArgList = function(method, args) {
    for (let i = 1; i < dart.notNull(args[$length]); i++) {
      ...
      message.write(IterableOfString()._check(args[$take](numArgs)[$map](core.String, dart.fn(arg => arg == null ? "null" : "\"" + dart.str(arg) + "\"", StringToString())))[$join](", "));
