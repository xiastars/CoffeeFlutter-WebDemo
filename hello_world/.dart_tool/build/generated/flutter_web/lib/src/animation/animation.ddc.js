define(['dart_sdk', 'packages/flutter_web/src/foundation/assertions', 'packages/flutter_web_ui/ui', 'packages/flutter_web/src/physics/clamped_simulation', 'packages/flutter_web/src/scheduler/binding', 'packages/flutter_web/services', 'packages/flutter_web/src/gestures/arena', 'packages/flutter_web/src/services/clipboard'], function(dart_sdk, assertions, ui, clamped_simulation, binding, services, arena, clipboard) {
  'use strict';
  ...
  dart.defineLazy(src__animation__curves.Curves, {
    ...
    /*src__animation__curves.Curves.easeInSine*/get easeInSine() {
      return dart.const(new src__animation__curves.Cubic.new(0.47, 0, 0.745, 0.715));
    },
    ...
    /*src__animation__curves.Curves.easeInOutQuart*/get easeInOutQuart() {
      return dart.const(new src__animation__curves.Cubic.new(0.77, 0, 0.175, 1.0));
    },
    /*src__animation__curves.Curves.easeInOutQuint*/get easeInOutQuint() {
      return dart.const(new src__animation__curves.Cubic.new(0.86, 0, 0.07, 1.0));
    },
    /*src__animation__curves.Curves.easeInOutExpo*/get easeInOutExpo() {
      return dart.const(new src__animation__curves.Cubic.new(1.0, 0, 0, 1.0));
    },
  ...
  (src__animation__animations.TrainHoppingAnimation.new = function(currentTrain, nextTrain, opts) {
    ...
    if (!(currentTrain != null)) dart.assertFailed();
  ...
  src__widgets__focus_manager.FocusNode = class FocusNode extends src__foundation__change_notifier.ChangeNotifier {
    get hasFocus() {
      return dart.equals((() => {
        let t = this[_manager];
        return t == null ? null : t[_currentFocus];
      })(), this);
    }
    ...
    unfocus() {
      let t = this[_parent$0];
      t == null ? null : t[_resignFocus](this);
      if (!(this[_parent$0] == null)) dart.assertFailed();
      if (!(this[_manager] == null)) dart.assertFailed();
    }
    dispose() {
      let t = this[_manager];
      t == null ? null : t[_willDisposeFocusNode](this);
      let t$ = this[_parent$0];
      t$ == null ? null : t$[_resignFocus](this);
      if (!(this[_parent$0] == null)) dart.assertFailed();
      if (!(this[_manager] == null)) dart.assertFailed();
  ...
  src__widgets__focus_manager.FocusScopeNode = class FocusScopeNode extends Object_DiagnosticableTreeMixin$ {
    ...
    [_prepend](child) {
      ...
      t == null ? this[_lastChild] = child : t;
    ...
    [_updateManager](manager) {
      function update(child) {
        ...
        if (manager != null) {
          let l = child[_focus];
          l == null ? null : l[_manager] = manager;
        }
    ...
    [_didChangeFocusChain]() {
      if (dart.test(this.isFirstFocus)) {
        let t = this[_manager];
        t == null ? null : t[_markNeedsUpdate]();
      }
    }
    requestFocus(node) {
  ...
  src__widgets__focus_manager.FocusManager = class FocusManager extends core.Object {
    ...
    [_update]() {
      ...
      previousFocus == null ? null : previousFocus[_notify]();
      let t = this[_currentFocus];
      t == null ? null : t[_notify]();
    }
    toString() {
      if (dart.test(src__util.assertionsEnabled)) {
  ...
  (src__widgets__scroll_simulation.ClampingScrollSimulation.new = function(opts) {
    ...
    if (!(src__widgets__scroll_simulation.ClampingScrollSimulation._flingVelocityPenetration(0.0) === 3.065)) dart.assertFailed();
  ...
  (src__widgets__icon_theme_data.IconThemeData.fallback = function() {
    this[color$] = const$ || (const$ = dart.const(new ui$.Color.new(4278190080)));
    this[_opacity] = 1.0;
    this[size$] = 24.0;
    src__widgets__icon_theme_data.IconThemeData.__proto__.new.call(this);
  }).prototype = src__widgets__icon_theme_data.IconThemeData.prototype;
  dart.addTypeTests(src__widgets__icon_theme_data.IconThemeData);
  const color$ = Symbol("IconThemeData.color");
  const size$ = Symbol("IconThemeData.size");
  ...
  dart.setMethodSignature(src__painting__image_stream.ImageStreamCompleter, () => ({
    ...
    reportError: dart.fnType(dart.void, [], {context: core.String, exception: dart.dynamic, stack: core.StackTrace, informationCollector: dart.fnType(dart.void, [core.StringBuffer]), silent: core.bool})
  }));
  ...
  dart.setFieldSignature(src__painting__image_stream.MultiFrameImageStreamCompleter, () => ({
    ...
    [_informationCollector]: dart.finalFieldType(StringBufferTovoid()),
  ...
  (src__painting__box_shadow.BoxShadow.new = function(opts) {
    let color = opts && 'color' in opts ? opts.color : const$0 || (const$0 = dart.const(new ui$.Color.new(4278190080)));
  ...
  const color$0 = Symbol("BoxShadow.color");
  ...
  const size$0 = Symbol("ImageConfiguration.size");
  ...
  src__painting__box_fit.applyBoxFit = function(fit, inputSize, outputSize) {
    if (dart.notNull(inputSize.height) <= 0.0 || dart.notNull(inputSize.width) <= 0.0 || dart.notNull(outputSize.height) <= 0.0 || dart.notNull(outputSize.width) <= 0.0) return const$1 || (const$1 = dart.const(new src__painting__box_fit.FittedSizes.new(ui$.Size.zero, ui$.Size.zero)));
  ...
  src__painting__gradient._interpolateColorsAndStops = function(aColors, aStops, bColors, bStops, t) {
    ...
    if (aStops != null || bStops != null) {
      let t$ = aStops;
      t$ == null ? aStops = const$2 || (const$2 = dart.constList([0.0, 1.0], core.double)) : t$;
      let t$0 = bStops;
      t$0 == null ? bStops = const$3 || (const$3 = dart.constList([0.0, 1.0], core.double)) : t$0;
  ...
  src__painting__text_style.TextStyle = class TextStyle extends src__foundation__diagnostics.Diagnosticable {
    ...
    static lerp(a, b, t) {
      if (!(t != null)) dart.assertFailed();
      if (!(a == null || b == null || a.inherit == b.inherit)) dart.assertFailed();
      if (a == null && b == null) {
        return null;
      }
      ...
      return new src__painting__text_style.TextStyle.new({inherit: b.inherit, color: a.foreground == null && b.foreground == null ? ui$.Color.lerp(a.color, b.color, t) : null, backgroundColor: a.background == null && b.background == null ? ui$.Color.lerp(a.backgroundColor, b.backgroundColor, t) : null, fontFamily: dart.notNull(t) < 0.5 ? a.fontFamily : b.fontFamily, fontFamilyFallback: dart.notNull(t) < 0.5 ? a.fontFamilyFallback : b.fontFamilyFallback, fontSize: ui$.lerpDouble(a.fontSize != null ? a.fontSize : b.fontSize, b.fontSize != null ? b.fontSize : a.fontSize, t), fontWeight: ui$.FontWeight.lerp(a.fontWeight, b.fontWeight, t), fontStyle: dart.notNull(t) < 0.5 ? a.fontStyle : b.fontStyle, letterSpacing: ui$.lerpDouble(a.letterSpacing != null ? a.letterSpacing : b.letterSpacing, b.letterSpacing != null ? b.letterSpacing : a.letterSpacing, t), wordSpacing: ui$.lerpDouble(a.wordSpacing != null ? a.wordSpacing : b.wordSpacing, b.wordSpacing != null ? b.wordSpacing : a.wordSpacing, t), textBaseline: dart.notNull(t) < 0.5 ? a.textBaseline : b.textBaseline, height: ui$.lerpDouble(a.height != null ? a.height : b.height, b.height != null ? b.height : a.height, t), locale: dart.notNull(t) < 0.5 ? a.locale : b.locale, foreground: a.foreground != null || b.foreground != null ? dart.notNull(t) < 0.5 ? a.foreground != null ? a.foreground : (() => {
          ...
          return _;
        })() : null, shadows: dart.notNull(t) < 0.5 ? a.shadows : b.shadows, decoration: dart.notNull(t) < 0.5 ? a.decoration : b.decoration, decorationColor: ui$.Color.lerp(a.decorationColor, b.decorationColor, t), decorationStyle: dart.notNull(t) < 0.5 ? a.decorationStyle : b.decorationStyle, debugLabel: lerpDebugLabel});
    }
    getTextStyle(opts) {
    ...
    compareTo(other) {
      ...
      if (!dart.equals(this.color, other.color) || !dart.equals(this.backgroundColor, other.backgroundColor) || !dart.equals(this.decoration, other.decoration) || !dart.equals(this.decorationColor, other.decorationColor) || this.decorationStyle != other.decorationStyle) return src__painting__basic_types.RenderComparison.paint;
  ...
  const color$1 = Symbol("TextStyle.color");
  const backgroundColor$ = Symbol("TextStyle.backgroundColor");
  const fontFamily$0 = Symbol("TextStyle.fontFamily");
  ...
  (src__painting__strut_style.StrutStyle.new = function(opts) {
    ...
    this[fontFamily$1] = package$1 == null ? fontFamily : "packages/" + dart.str(package$1) + "/" + dart.str(fontFamily);
    this[_fontFamilyFallback$] = fontFamilyFallback;
    this[_package$] = package$1;
  ...
  (src__painting__strut_style.StrutStyle.fromTextStyle = function(textStyle, opts) {
    ...
    if (!(leading == null || dart.notNull(leading) >= 0)) dart.assertFailed();
    if (!(package$1 == null || package$1 != null && (fontFamily != null || fontFamilyFallback != null))) dart.assertFailed();
    this[fontFamily$1] = fontFamily != null ? package$1 == null ? fontFamily : "packages/" + dart.str(package$1) + "/" + dart.str(fontFamily) : textStyle.fontFamily;
  ...
  const fontFamily$1 = Symbol("StrutStyle.fontFamily");
  ...
  src__painting__text_span.TextSpan = class TextSpan extends src__foundation__diagnostics.DiagnosticableTree {
    ...
    debugDescribeChildren() {
      if (this.children == null) return const$4 || (const$4 = dart.constList([], src__foundation__diagnostics.DiagnosticsNode));
  ...
  src__painting__text_painter.TextPainter = class TextPainter extends core.Object {
    ...
    get preferredLineHeight() {
      if (this[_layoutTemplate] == null) {
        ...
        builder.addText(" ");
        let _ = builder.build();
        _.layout(const$5 || (const$5 = dart.const(new ui$.ParagraphConstraints.new({width: core.double.infinity}))));
    ...
    getOffsetForCaret(position, caretPrototype) {
      ...
      switch (position.affinity) {
        ...
        {
          let l = this[_getOffsetFromUpstream](offset, caretPrototype);
          let l$ = l != null ? l : this[_getOffsetFromDownstream](offset, caretPrototype);
          return l$ != null ? l$ : this[_emptyOffset];
        }
        case ui$.TextAffinity.downstream:
        {
          let l$0 = this[_getOffsetFromDownstream](offset, caretPrototype);
          let l$1 = l$0 != null ? l$0 : this[_getOffsetFromUpstream](offset, caretPrototype);
          return l$1 != null ? l$1 : this[_emptyOffset];
        }
      }
      return null;
    }
