...
class HState extends State<Home> {
  ...
  getData() async {
    var headers = {"Access-Control-Allow-Credentials":"true","Access-Control-Allow-Origin":"http://localhost:8080"};
    http.Response r =
        await http.get('https://movie.douban.com/j/search_subjects?type=movie&tag=%E6%9C%80%E6%96%B0&page_limit=50&page_start=0',headers:headers);
                    ...
                    return Container(
                        ...
                        child: ClipRRect(
                          ...
                          child: Hero(
                              tag: fd[i]['title'],
                              child:
                                  Image.asset(fd[i]['cover'], fit: BoxFit.cover)),
                        ));
                  },
                  viewportFraction: .85,
                  scale: .9)),
